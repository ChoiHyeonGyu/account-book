...
<div class="panel panel-default row">
	...
	<div class="panel-body">
		<div class="flot-chart2">
				 <span>이번달 </span>&emsp;&emsp;&emsp;<span>${profilegraph.photo}원</span>
		 <div class="progress">
        <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:${profilegraph.total}%"><span>${profilegraph.total}%</span></div>
      </div>
      <span>1개월 전</span>
      <div class="progress">
        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph2.total}%"><span>${profilegraph2.total}%</span></div>
      </div>
      <span>2개월 전</span>
      <div class="progress">
        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph3.total}%"><span>${profilegraph3.total}%</span></div>
      </div>
      <span>3개월 전</span>
      <div class="progress">
        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph4.total}%"><span>${profilegraph4.total}%</span></div>
      </div>
      <span>4개월 전</span>
      <div class="progress">
        <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph5.total}%"><span>${profilegraph5.total}%</span></div>
      </div>
       <span>5개월 전</span>
      <div class="progress">
        <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph6.total}%"><span>${profilegraph6.total}%</span></div>
      </div>
     <span>${profilegraph7.name}원 /</span>&emsp;<span>${profilegraph7.photo}원</span>
      <div class="progress">
        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${profilegraph7.total}%"><span>${profilegraph7.total}%</span></div>
      </div>
