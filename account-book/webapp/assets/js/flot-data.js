...
$(function() {
	...
	$("#graph-gender").mouseleave(function(){
		...
		var selectobj = {"gender":$("#graph-gender option:selected").text(), "age":$("#graph-age option:selected").text()}
	...
	$("#graph-age").mouseleave(function(){
		...
		var selectobj2 = {"gender":$("#graph-gender option:selected").text(), "age":$("#graph-age option:selected").text()}
