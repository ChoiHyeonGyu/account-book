...
public class ListController {
	...
	public JSONResult checkUpdate1(@PathVariable String id, @RequestBody Map<String, Object> map){
		return JSONResult.success(Pservice.checkUpdate1(map.get("").toString()));
	}*/
